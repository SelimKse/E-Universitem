...
public class TeacherLogin extends AppCompatActivity {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!usernameText.isEmpty() && !passwordText.isEmpty()) {
                    // Login işlemi burada yapılır (örneğin API isteği)
                    // Başarılı girişten sonra DashboardActivity'ye geçiş
                    loginStudent(usernameText, passwordText);
                } else {
                    Toast.makeText(TeacherLogin.this, "Lütfen gerekli alanları doldurun!", Toast.LENGTH_SHORT).show();
                }
    ...
    public void onBackPressed() {
        // Yeni bir intent oluşturun (örneğin MainActivity'ye gitmek için)
        Intent intent = new Intent(this, MainActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        // Yeni intent'i başlatın
        startActivity(intent);

        // Bu Activity'i bitirin (geçerli activity'yi kapatmak için)
        finish();
    }


    private void loginStudent(String usernameText, String passwordText) {
        String url = "https://api.e-universitem.com/login/ogretmen/giris"; // Buraya kendi API URL'ini yaz
        ...
        try {
            loginParams.put("ogretmen_eposta", usernameText);
            loginParams.put("ogretmen_sifre", passwordText);
        } catch (JSONException e) {
            hideLoader();
            e.printStackTrace();
            Toast.makeText(TeacherLogin.this, "JSON oluşturulurken hata oluştu!", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            SecurePreferences securePreferences = SecurePreferences.getInstance(TeacherLogin.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(TeacherLogin.this, "Bir hata oluştu!", Toast.LENGTH_SHORT).show();
                        }

                        showLoader();

                        Intent intent = new Intent(TeacherLogin.this, TeacherMainPage.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();
                        ...
                        Toast.makeText(TeacherLogin.this, "Giriş Başarılı", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof com.android.volley.TimeoutError) {
                            Toast.makeText(TeacherLogin.this, "İnternet bağlantınızı kontrol edin!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TeacherLogin.this, "Bir hata oluştu!", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        if (error.networkResponse != null) {
                            ...
                            if(statusCode == 401) {
                                Toast.makeText(TeacherLogin.this, "Öğretmen Epostası veya Şifre Hatalı!", Toast.LENGTH_SHORT).show();
                            }

                            if (statusCode == 500) {
                                Toast.makeText(TeacherLogin.this, "Sunucu Hatası!", Toast.LENGTH_SHORT).show();
                            }
