...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/ders/ogrenci-tanımla.css">
...
<body>
    ...
    <div class="container">
                                ...
                                <div class="ders" id="<?= $ders['ders_id'] ?>">
                                    ...
                                    <div class="icons">
                                        <i class="fa-solid fa-user-plus"
                                            onclick="ogrenciEkle(event, '<?= $ders['ders_id'] ?>')"></i>
                                        <i class="fa-solid fa-eye"
                                            onclick="ogrenciListe(event, '<?= $ders['ders_id'] ?>')"></i>
                                    </div>
                                </div>
                            </li>
                        <?php endforeach; ?>
        ...
        <div class="ogrenciListe">
            <div class="content">
                <h2>Öğrenci Listesi</h2>
                <i class="fas fa-times closeButton" onclick="closeOgrenciListe()"></i>
                <div class="ogrenciListeContainer">
                    <div class="search">
                        <i class="fas fa-search"></i>
                        <input type="text" id="searchOgrenci" placeholder="Öğrenci belirtin...">
                    </div>
                    <div class="ogrenciList" id="ogrenciList">
        ...
        <div class="ogrenciEkle">
            <div class="content">
                <h2>Öğrenci Ekle</h2>
                <i class="fas fa-times closeButton" onclick="closeOgrenciEkle()"></i>
                <div class="ogrenciEkleContainer">
                    <div class="search">
                        <i class="fas fa-search"></i>
                        <input type="text" id="searchOgrenci2" placeholder="Öğrenci belirtin...">
                    </div>
                    <div class="ogrenciBul" id="ogrenciBul">
                        <?php foreach ($ogrenciler as $ogrenci): ?>
                            <li id="<?= $ogrenci['ogrenci_no'] ?>">
                                <!-- Öğrenci Bilgisi -->
                                <div class="ogrenci" id="<?= $ogrenci['ogrenci_no'] ?>">
                                    ...
                                    <div class="icons">
                                        <i class="fa-solid fa-plus"
                                            onclick="dersEkle(event, <?= $ogrenci['ogrenci_no'] ?>)"></i>
                                    </div>
                                </div>
                            </li>
                        <?php endforeach; ?>
...
<script src="../../public/js/ders/ogrenci-tanımla.js"></script>
