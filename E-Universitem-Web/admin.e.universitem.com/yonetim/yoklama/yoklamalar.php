...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/yoklama/yoklamalar.css">
        ...
        <div class="box">
            ...
            <div class="listBox">
                <div class="search">
                    ...
                    <input type="text" id="search_yoklama" placeholder="Ara...">
                </div>
                <div class="liste">
                    <ul id="yoklamalar">
                        <?php foreach ($yoklamalar as $yoklama): ?>
                            <li>
                                <div class="yoklama" id="<?= $yoklama['yoklama_id'] ?>">
                                    ...
                                    <span class="ogretmen_adi" id="<?= $yoklama['yoklama_id'] ?>"
                                        data-id="<?= $yoklama["ogretmen_no"] ?>"></span>
                                    <div class="icons">
                                        <i class="fas fa-eye"
        ...
        <div class="katilanOgrenciler">
            <div class="content">
                ...
                <div class="katilanOgrencilerContainer">
                    <span id="katilan_ogrenciler_liste"></span>
                </div>
            </div>
        </div>
    </div>
...
<script src="../../public/js/yoklama/yoklamalar.js"></script>
