...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/ogrenci/ders-tanımla.css">
        ...
        <div class="box">
            ...
            <div class="listBox">
                <div class="search">
                    ...
                    <input type="text" id="search" placeholder="Öğrenci belirtin...">
                </div>
                <div class="liste">
                    <ul id="ogrenciler">
                                    ...
                                    <form>
                                        ...
                                        <div id="buttons">
                                            <button type="button" class="kaydet"
                                                onclick="dersKaydet(event, <?= $ogrenci['ogrenci_no'] ?>)">Kaydet</button>
                                        </div>
                                    </form>
                                </div>
                            </li>
...
<script src="../../public/js/ogrenci/ders-tanımla.js"></script>
