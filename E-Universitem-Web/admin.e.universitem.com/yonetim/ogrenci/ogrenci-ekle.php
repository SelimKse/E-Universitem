...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/ogrenci/ogrenci-ekle.css">
...
<body>
    ...
    <div class="container">
        <div class="box">
            ...
            <div class="formBox">
                <h2>Öğrenci Ekle</h2>
                <form method="POST" id="ogrenciEkleForm" onsubmit="return ogrenciEkle(event);">
                    <div class="inputBox">
                        <div class="ogrenciNo">
                            <label for="ogrenciNo">Öğrenci Numarası</label>
                            <input type="text" id="ogrenciNo" placeholder="012345678" name="ogrenciNo" required
                                pattern="^\d{9}$" title="Öğrenci numarası 10 haneli olmalıdır."
                                title="Öğrenci numarası 10 haneli olmalıdır. Sadece Rakam İçermelidir!">
                        </div>
                        <div class="ogrenciName">
                            <label for="ad">İsim</label>
                            <input type="text" id="ogrenciAdı" placeholder="Öğrenci Adı" name="ogrenciAdı" required
                                pattern="^[a-zA-ZğüşöçıİĞÜŞÖÇ\s]+$" title="İsim sadece harf içerebilir."
                                title="İsim sadece harf içerebilir.">
                        </div>
                        <div class="ogrenciSoyad">
                            <label for="soyad">Soyisim</label>
                            <input type="text" id="ogrenciSoyadı" placeholder="Öğrenci Soyadı" name="ogrenciSoyadı" required
                                pattern="^^[a-zA-ZğüşöçıİĞÜŞÖÇ\s]+$" title="Soyisim sadece harf içerebilir."
                                title="Soyisim sadece harf içerebilir.">
                        </div>
                        <div class="ogrenciEposta">
                            <label for="eposta">E-Posta</label>
                            <input type="email" id="ogrenciEposta" placeholder="example@iste.edu.tr"
                                name="ogrenciEposta" required>
                        </div>
                        <div class="ogrenciSifre">
                            <label for="sifre">Şifre</label>
                            <input type="password" id="ogrenciSifre" placeholder="Öğrenci Şifresi (Geçici)"
                                name="ogrenciSifre" required
...
<script src="../../public/js/ogrenci/ogrenci-ekle.js"></script>
