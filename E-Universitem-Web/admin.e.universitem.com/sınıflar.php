...
<head>
    ...
    <link rel="stylesheet" href="./public/css/sınıf/sınıflar.css">
    ...
    <div class="container">
        <div class="box">
            ...
            <div class="listBox">
                ...
                <div class="liste">
                    <ul id="sınıflar">
                        <?php foreach ($sınıflar as $sınıf): ?>
                            <li>
                                <div class="sınıf" id="<?= $sınıf['sinif_id'] ?>">
                                    <span><?= $sınıf['sinif_adi'] ?></span>
                                    <div class="icons">
                                        <i class="fas fa-edit" onclick="editSınıf(event, <?= $sınıf['sinif_id'] ?>)"></i>
                                        <i class="fas fa-trash" onclick="deleteSınıf(event, <?= $sınıf['sinif_id'] ?>)"></i>
                                    </div>
                                </div>
                            </li>
                        <?php endforeach; ?>
        ...
        <div class="editBox">
            <div class="content">
                <h2>Sınıf Düzenle</h2>
                <div class="editForm">
                    <i class="fas fa-times" onclick="closeEditForm(event)"></i>
                    <input type="text" id="editSınıfAdi" placeholder="Sınıf Adı">
                    <button onclick="updateSınıf(event)">Düzenle</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="./public/js/sınıf/sınıflar.js"></script>
