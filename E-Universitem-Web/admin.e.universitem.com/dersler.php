...
<head>
    ...
    <link rel="stylesheet" href="./public/css/ders/dersler.css">
                        ...
                        <?php foreach ($dersler as $ders): ?>
                            <li>
                                <div class="ders" id="<?= $ders['ders_id'] ?>">
                                    ...
                                    <div class="icons">
                                        <i class="fas fa-edit" onclick="editDers(event, <?= $ders['ders_id'] ?>)"></i>
                                        <i class="fas fa-trash" onclick="deleteDers(event, <?= $ders['ders_id'] ?>)"></i>
                                    </div>
                                </div>
                            </li>
                        <?php endforeach; ?>
        ...
        <div class="editBox">
            <div class="content">
                ...
                <div class="editForm">
                    ...
                    <input type="text" id="editDersAdi" placeholder="Ders Adı">
                    <button onclick="updateDers(event)">Düzenle</button>
                </div>
            </div>
        </div>
</body>
<script src="./public/js/ders/dersler.js"></script>
