            ...
            <div class="main-content">
                <div class="box analiz">
                    ...
                    <div class="card-counter">
                        ...
                        <div class="count-name">Bugün Girilen Yoklamalar</div>
                    </div>
                    <div class="card-counter">
                        <i class="fa fa-calendar-week"></i>
                        <div class="count-numbers" id="haftalik-yoklama-sayi">0</div>
                        <div class="count-name">Haftalık Girilen Yoklamalar</div>
                    </div>
                    <div class="card-counter">
                        <i class="fa fa-calendar-days"></i>
                        <div class="count-numbers" id="aylik-yoklama-sayi">0</div>
                        <div class="count-name">Aylık Girilen Yoklamalar</div>
                    </div>
                    <div class="card-counter">
                ...
                <div class="box top-lesson">
                    <div class="box-header">
                        ...
                        <h3 class="box-title">Sık Katıldığın Dersler</h3>
                    </div>
                ...
                <div class="box last-lesson">
                    <div class="box-header">
                        ...
                        <h3 class="box-title">Son Katıldığın Dersler</h3>
                    </div>
